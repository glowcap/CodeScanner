  ...
  public class ScannerViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, AVCaptureMetadataOutputObjectsDelegate {
    ...
    public func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey: Any]) {
      ...
      if let qrcodeImg = info[.originalImage] as? UIImage {
        ...
        print(Constants.Text.qrcodeImgFailed)
      }
    ...
    override public func loadView() {
      ...
      label.text = Constants.Text.runningInSimulator
      label.textAlignment = .center
      
      let button = UIButton()
      button.translatesAutoresizingMaskIntoConstraints = false
      button.setTitle(Constants.Text.selectCustomImage, for: .normal)
    ...
    private lazy var viewFinder: UIImageView? = {
      guard let image = UIImage(named: Constants.Image.viewFinder, in: .module, with: nil) else {
        return nil
      }
    ...
    private lazy var manualCaptureButton: UIButton = {
      ...
      let image = UIImage(named: Constants.Image.capture, in: .module, with: nil)
    ...
    private lazy var manualSelectButton: UIButton = {
      let button = UIButton(type: .system)
      let image = UIImage(systemName: Constants.Image.photoStack)
      let background = UIImage(systemName: Constants.Image.capture)?.withTintColor(.systemBackground, renderingMode: .alwaysOriginal)
